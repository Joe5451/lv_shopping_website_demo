...
<div class="container mx-auto px-4 pb-8">
    ...
    <nav class="admin_sub_nav custom_horizontal_scrollbar">
        <a href="news_category_list" class="admin_sub_nav_link">列表</a>
        <a href="news_category_add_form" class="admin_sub_nav_link active">新增</a>
    </nav>
    
    <form action="news_category_add" method="post" class="admin_form max-w-screen-sm" enctype="multipart/form-data">
